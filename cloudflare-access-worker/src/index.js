...
const DEFAULT_MESSAGE_DESIGN = Object.freeze({
  ...
  titleOffsetX: 0,
  titleOffsetY: 0,
  titleBoxWidthPct: 100,
  titleBoxHeightPx: 64,
  titleBoxFrameEnabled: true,
  titleAutoFit: true,
  bodyFontSize: 14,
  bodyColor: "#ffffff",
  bodyBold: false,
...
function sanitizeMessageDesign(value) {
  ...
  return {
    ...
    titleBoxWidthPct: clampNumber(raw.titleBoxWidthPct, 35, 100, DEFAULT_MESSAGE_DESIGN.titleBoxWidthPct),
    titleBoxHeightPx: clampNumber(raw.titleBoxHeightPx, 38, 180, DEFAULT_MESSAGE_DESIGN.titleBoxHeightPx),
    titleBoxFrameEnabled: raw.titleBoxFrameEnabled === undefined ? true : Boolean(raw.titleBoxFrameEnabled),
    titleAutoFit: raw.titleAutoFit === undefined ? true : Boolean(raw.titleAutoFit),
    ...
    bodyBoxWidthPct: clampNumber(raw.bodyBoxWidthPct, 35, 100, DEFAULT_MESSAGE_DESIGN.bodyBoxWidthPct),
    bodyBoxHeightPx: clampNumber(raw.bodyBoxHeightPx, 60, 360, DEFAULT_MESSAGE_DESIGN.bodyBoxHeightPx),
    bodyBoxFrameEnabled: raw.bodyBoxFrameEnabled === undefined ? true : Boolean(raw.bodyBoxFrameEnabled),
    bodyAutoFit: raw.bodyAutoFit === undefined ? true : Boolean(raw.bodyAutoFit),
