...
// User configurable.
const ROM_FILENAME = '/gba-nfc/games/Tetris Blast.gb';
...
class Video {
  constructor(module, e, el) {
    ...
    // En modo biblioteca usamos Canvas2D directamente.
    if (
      LIBRARY_MODE ||
      ...
      try {
        ...
        console.log(
          `Error creating WebGLRenderer: ${error}`
        );

        this.renderer =
          new Canvas2DRenderer(el);
      }
    }
