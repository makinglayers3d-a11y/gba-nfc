...
const buttonColors = document.getElementById("button-colors");
 const gameConfig = {
  pokemon: {
    ...
    rom: "/gba-nfc/games/PokemonRF.gba"
  },

  mario3: {
    name: "Super Mario Bros. 3",
    rom: "/gba-nfc/games/Super Mario Bros. 3.gba"
  },

  minishcap: {
    name: "The Legend of Zelda: The Minish Cap",
    rom: "/gba-nfc/games/The Legend of Zelda - The Minish Cap.gba"
  },
...
let selected =
  requestedRom
    ? {
        name: requestedRom,
        rom: "/gba-nfc/games/" + requestedRom
      }
